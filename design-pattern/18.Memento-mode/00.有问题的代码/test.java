class test{
    public static void main(String[] args) {
        ...
        backup.setVitality(c.getVitality());
        backup.setAttack(c.getAttack());
        backup.setDefense(c.getDefense());
        ...
        //恢复之前的状态
        c.setAttack(backup.getAttack());
        c.setDefense(backup.getDefense());
        c.setVitality(backup.getVitality());
